...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                int upperBound = data[data.length - 1];
                bubbleSortAscending(data, lowerBound, upperBound);
                break;
            //Lanjutkan
            case 6:
    ...
    public static void bubbleSortAscending(int[] arr, int lowerBound, int upperBound) {
        int len = arr.length;
